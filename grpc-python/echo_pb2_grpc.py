...
class echoerStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.SayEcho = channel.stream_stream(
                '/echoer/SayEcho',
...
def add_echoerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayEcho': grpc.stream_stream_rpc_method_handler(
                    servicer.SayEcho,
    ...
    server.add_registered_method_handlers('echoer', rpc_method_handlers)
